/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════
   Usage : icon('package')         → SVG taille par défaut (18px)
           icon('package', 24)     → SVG taille 24px
           icon('package', 24, 'class-name') → avec classe
   ═══════════════════════════════════════════════════════════════ */
...
const ICONS = {
  ...
  utensils: '<path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8"/><path d="M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6L7.5 14a3 3 0 0 0 4.2 0L15 11"/><path d="m2 2 7.5 7.5"/>',
  ...
  // ── Éditeur markdown ─────────────────────────────
  bold: '<path d="M6 12h9a4 4 0 0 1 0 8H6z"/><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/>',
...
/**
 * Retourne le SVG d'une icône Lucide.
 * @param {string} name - Nom de l'icône (ex: 'package', 'cart')
 * @param {number} [size=18] - Taille en pixels (largeur = hauteur)
 * @param {string} [className=''] - Classe CSS optionnelle
 * @param {number} [strokeWidth=2] - Épaisseur du trait
 * @returns {string} HTML du SVG
 */
function icon(name, size = 18, className = '', strokeWidth = 2) {
  const path = ICONS[name];
  if (!path) {
    console.warn(`icon('${name}') : icône introuvable`);
    return `<span title="Icône ${name} manquante">?</span>`;
  }
