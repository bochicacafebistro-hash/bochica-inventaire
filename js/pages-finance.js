// ═══════════════════════════════════════════════════════════════
// FINANCES — Dépenses, Revenus, Catégories, Frais fixes, Rapports
  ...
  showModal(`<div class="modal">
    ...
    <div style="margin-bottom:12px">
      ${templates.length === 0
        ...
        : templates.map(tpl => `<div class="cat-item" style="justify-content:space-between">
            <div style="flex:1">
              <div style="font-weight:600;font-size:13px">${tpl.supplier||tpl.description||"—"}</div>
              <div style="font-size:11px;color:var(--text3)">${tpl.category||""} · ${fmtMoney(tpl.amount)}</div>
            </div>
