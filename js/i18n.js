...
const TRANSLATIONS = {
  ...
  // ── Recettes (composition + analyse coûts) ────────
  rec_title:             { fr: "Recettes",            es: "Recetas" },
  rec_subtitle:          { fr: "Composition et rentabilité des plats du menu", es: "Composición y rentabilidad de los platos del menú" },
  rec_no_recipes:        { fr: "Aucune recette définie. Allez dans le Menu et ajoutez la composition d'un plat.", es: "Ninguna receta definida. Vaya al Menú y agregue la composición de un plato." },
  rec_food_cost:         { fr: "Coût de revient",     es: "Costo de receta" },
  rec_selling_price:     { fr: "Prix de vente",       es: "Precio de venta" },
  rec_margin:            { fr: "Marge",               es: "Margen" },
  rec_margin_pct:        { fr: "Marge %",             es: "Margen %" },
  rec_no_price:          { fr: "Pas de prix défini",  es: "Sin precio definido" },
  rec_no_composition:    { fr: "Aucune composition",  es: "Sin composición" },
  rec_top_profitable:    { fr: "Plus rentables",      es: "Más rentables" },
  rec_top_expensive:     { fr: "Plus chers à produire", es: "Más caros de producir" },
  rec_filter_all:        { fr: "Tous",                es: "Todos" },
  rec_filter_with_recipe:{ fr: "Avec recette",        es: "Con receta" },
  rec_filter_without:    { fr: "Sans recette",        es: "Sin receta" },
  rec_avg_margin:        { fr: "Marge moyenne",       es: "Margen promedio" },
  rec_total_items:       { fr: "Items au menu",       es: "Items en el menú" },
