...
const TRANSLATIONS = {
  ...
  exp_field_notax:       { fr: "Sans taxes", es: "Sin impuestos" },
  exp_field_extras:      { fr: "Frais supplémentaires (optionnel)", es: "Cargos adicionales (opcional)" },
  exp_field_extras_hint: { fr: "Ex. frais de livraison, pourboire du livreur... Ajoutés au montant avant taxes.", es: "Ej. cargo de entrega, propina del repartidor... Se suman al monto antes de impuestos." },
  exp_extras_add:        { fr: "Ajouter un frais", es: "Agregar un cargo" },
  exp_extras_desc_ph:    { fr: "Ex. Frais de livraison", es: "Ej. Cargo de entrega" },
  exp_extras_empty:      { fr: "Aucun frais supplémentaire.", es: "Sin cargos adicionales." },
  exp_extras_subtotal:   { fr: "Sous-total (avec frais)", es: "Subtotal (con cargos)" },
  exp_quick_add_supplier: { fr: "Nouveau fournisseur", es: "Nuevo proveedor" },
  exp_quick_add_cat:     { fr: "Nouvelle catégorie", es: "Nueva categoría" },
  exp_quick_new_cat_title: { fr: "Nouvelle catégorie", es: "Nueva categoría" },
  exp_quick_new_cat_ph:  { fr: "Ex. Livraison, Uniformes...", es: "Ej. Entrega, Uniformes..." },
  exp_cat_exists:        { fr: "Cette catégorie existe déjà.", es: "Esta categoría ya existe." },
